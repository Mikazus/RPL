...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#f5f0e8' }}>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md animate-scaleUp">
          ...
          <div className="space-y-3 mb-6 animate-fadeIn opacity-0" style={{ animationDelay: '0.4s' }}>
            ...
            <button className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 hover:scale-[1.02] transition-all duration-300 btn-press">
              ...
              <span className="text-gray-700 font-medium">Login dengan Facebook</span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-4 mb-6 animate-fadeIn opacity-0" style={{ animationDelay: '0.5s' }}>
            ...
            <span className="text-gray-500 text-sm">Atau login dengan email</span>
            <div className="flex-1 h-px bg-gray-300"></div>
          </div>
          ...
          <div className="flex items-center justify-between mb-6 animate-fadeIn opacity-0" style={{ animationDelay: '0.8s' }}>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                checked={rememberMe}
                onChange={(e) => setRememberMe(e.target.checked)}
                className="w-4 h-4 text-yellow-700 border-gray-300 rounded focus:ring-yellow-700 transition-all duration-200"
              />
              <span className="text-gray-600 text-sm">Ingat saya</span>
            </label>
            <a href="#" className="text-sm hover:underline transition-all duration-200" style={{ color: '#8B6F47' }}>
              Lupa password?
            </a>
          </div>
          ...
          <button
            ...
            style={{ backgroundColor: '#8B6F47', animationDelay: '0.9s' }}
          >
            Login
          </button>

          {/* Register Link */}
          <p className="text-center mt-6 text-gray-600 text-sm animate-fadeIn opacity-0" style={{ animationDelay: '1s' }}>
            Belum punya akun?
            <Link to="/register" className="font-semibold hover:underline ml-1 transition-all duration-200" style={{ color: '#8B6F47' }}>
              Daftar sekarang
            </Link>
          </p>
        </div>
      ...
      {/* Footer */}
      <div className="text-center pb-6 animate-fadeIn opacity-0" style={{ animationDelay: '1.1s' }}>
